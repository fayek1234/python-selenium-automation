...
def verify_amazon_privacy_page_is_opened(context):
    #print(type(context.driver.wait))
    WebDriverWait(context.driver, 10).until(EC.url_contains('https://www.amazon.com/gp/help/customer/display'))
...
@step("go back to original window")
